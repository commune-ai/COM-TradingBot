...
const Home: React.FC<HomeProps> = () => {
  ...
  const globalData: GlobalData | undefined = data?.data?.stats;

  if (isFetching || !globalData) return <Loading />;
    ...
    <>
      ...
      <div className="home-heading-container">
        ...
        <Title level={3} className="show-more">
          <Link to="/trade/cryptocurrencies">Show More</Link>
        </Title>
      </div>
      ...
      <div className="home-heading-container">
        ...
        <Title level={3} className="show-more">
          <Link to="/trade/news">Show More</Link>
        </Title>
      </div>
      <News simplified />
    </>
